...
namespace YasminaaiApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static YasminaaiApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new YasminaaiApi.Core.MultipartFormRequest
        {
