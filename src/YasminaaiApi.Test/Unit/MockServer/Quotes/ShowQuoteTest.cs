...
public class ShowQuoteTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock.RequestBuilders.Request.Create().WithPath("/quote-requests/1").UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Quotes.ShowQuoteAsync(new GetQuoteRequestsIdRequest { Id = 1 });
