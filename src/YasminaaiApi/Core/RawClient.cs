...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::YasminaaiApi.Core.ApiResponse> SendRequestAsync(
        global::YasminaaiApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::YasminaaiApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::YasminaaiApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::YasminaaiApi.Core.BaseRequest request)
    {
